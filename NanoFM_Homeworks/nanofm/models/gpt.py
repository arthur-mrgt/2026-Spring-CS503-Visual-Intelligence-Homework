...
class GPT(nn.Module):
    ...
    def forward_model(self, x: torch.LongTensor) -> torch.Tensor:
        ...
        # Lower-triangular boolean: True = attend, False = masked-out. Shape: [1, L, L]
        ...
        # ??? TODO: Output normalization and projection to logits
    ...
    def compute_ce_loss(self, logits: torch.Tensor, target_seq: torch.LongTensor, padding_idx: int = -100) -> torch.Tensor:
        ...
        Returns:
             A scalar loss value.
        """
        # ??? TODO: Compute the cross-entropy loss, ignoring padding tokens
